...
export function Projects() {
  ...
  return (
    <section
      id="projects"
      className="relative flex h-[100svh] md:h-[100dvh] w-full snap-start snap-always scroll-mt-24 flex-col items-center justify-center overflow-hidden bg-bg pt-24 pb-[env(safe-area-inset-bottom)]"
    >
